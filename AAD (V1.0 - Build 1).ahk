...
; --- Initial Variables ---
Global LoopDelay := 100 
Global RebirthDelay := 1000 
Global CrunchKey := "c"
Global MaxAllKey := "m"
Global AutoTabKey := "a"
Global BoostKey := "d"
...
$q:: {
    ; If we are actively typing in an edit box, let the letter through
    if (ControlGetFocus(WinActive("A")) != 0 && !InStr(ControlGetFocus(WinActive("A")), "Button"))
        Send("q")
    else
        StartScript()
}
